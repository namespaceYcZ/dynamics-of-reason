...
在过去的二十年里，我一直致力于历史研究，探讨从#kant()（18世纪末）到#logical_empiricism()（20世纪初）#trans-note[
  ...
  3. *彻底的分析/综合二分法（Analytic/Synthetic Distinction）*——*【极其关键】*：
    ...
    逻辑经验主义者*拒绝了康德的“先天综合判断”*。他们认为，像几何学公理这样的基础框架，不是先天的心理结构，而仅仅是我们*约定俗成的语言规则（分析的先验）*。
  ...
  *#immanuel_kant()（Immanuel Kant）*：所有人都在回应他。他提出了“先天综合判断”（科学必须依赖某种先验的框架）。#logical_empiricism()试图*用逻辑和约定*替换他的先验；#quine()试图*彻底消灭*他的先验；库恩则用历史主义的范式展示了*一种不断变动的“社会化先验”*。
  ...
  3. *#friedman()的解法*：他要证明#quine()是错的！他主张，把*#carnap()的“语言框架”*和*#kuhn()的“科学革命”*结合起来。科学确实有范式转换（#kuhn()），但这恰恰证明了科学不仅有平面的经验事实，还有具有构成性作用的“先验框架”（#carnap()/#kant()）。只不过，这种先验框架不再是#kant()那里永恒不变的，而是在历史中*动态演化、相对化*的。

  通过这种“动态先验论”，#friedman()试图同时*拯救#kant()的先验规范性*、*挽回#logical_empiricism()的科学逻辑分层*，并*消化#kuhn()的科学历史演变*。
