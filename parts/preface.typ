...
在过去的二十年里，我一直致力于历史研究，探讨从#kant()（18世纪末）到#logical_empiricism()（20世纪初）#trans-note[
  *#logical_empiricism()*
  ...
  1. *意义的证实准则（Verifiability Principle）*：
    一个陈述如果有意义，它要么是*经验上可证实的*（通过观察和实验），要么是*逻辑/数学上的重言式*（同义反复）。
  2. *拒斥形而上学（Anti-Metaphysics）*：
    基于上述准则，传统哲学（如黑格尔的“绝对精神”、海德格尔的“无无化”）既不能经验证实，也不是逻辑真理，因此它们*不是假的，而是毫无意义的（meaningless）伪命题*。
  3. *彻底的分析/综合二分法（Analytic/Synthetic Distinction）*——*【极其关键】*：
  ...
  *#rudolf_carnap()（Rudolf Carnap）*：#logical_empiricism()的灵魂人物，也是#friedman()最看重的人。他提出了*“语言框架”（Linguistic Framework）*理论。他认为，科学理论在内部有真假可言，但选择哪个理论框架（比如选欧氏几何还是非欧几何），没有真假，只有“方便与否”的实用考量。*#friedman()的“#relativized_a_priori()”正是基于卡尔纳普的框架理论改造而来的。*
