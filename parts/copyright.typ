...
正式出版后，某些编目版本会替换为实际数据（如“xiv, 141 p. ; 23 cm.”）。此处保留的仍是“p. cm.”，即CIP的原始预编目形式。
...
说明：在任何采用LCC系统的图书馆（多数英美大学图书馆），本书都被归入Q175 .F892 2001索书号之下，与其他科学哲学经典（如Popper、Kuhn、Lakatos的著作）为邻。
